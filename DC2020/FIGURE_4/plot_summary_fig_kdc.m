...
leg.Box = 'off';
 ...
 AX = gca;
 pos = AX.Position;
 set(gca,'Position',[pos(1), pos(2)*1.3, pos(3:4)]);
...
plot(tLim,[90,90],'-', 'Color', c(7,:),'LineWidth',1)
plot(tLim,[110,110],'-', 'Color', c(5,:),'LineWidth',1)
...
scatter(decyear2dt(catS(:,3)),catS(:,6),(catS(:,6)+0.5).^1.3, ...
    'filled', ...
    'MarkerFaceColor',[0.6 0.6 0.6],...
    'MarkerFaceAlpha',0.3); 
hold on
scatter(decyear2dt(Tms2),MMS,(MMS+0.5).^1.3,'r','filled','MarkerFaceAlpha',0.3);
